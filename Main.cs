...
namespace Script
{
    ...
    public partial class Main
    {
        ...
        public static int ExpBonus = 100;
        ...
        public static void LeftGame(Client client)
        {
            try
            {
                ...
                else
                {
                    ...
                    { //NetScript.GetPlayerName(index) != "Pikachu") {// && NetScript.GetPlayerName(index) != "Shockie") {
                        Messenger.GlobalMsg("[" + GetRankName(client.Player.Access) + "] " + client.Player.Name + " has left " + Settings.GameName + "!", Text.BrightGreen);
                    }
                    else
                    {
                        Messenger.AdminMsg("[" + GetRankName(client.Player.Access) + "] " + client.Player.Name + " has left " + Settings.GameName + "!", Text.BrightGreen);
                    }
                }
